...
public class AudioPlayer implements AudioPlayerInterface {
    ...
    private static final String BACKGROUND_MUSIC_FILE = "space.mp3";
    private static final String CRASH_SOUND_FILE = "drop.mp3";

    private static final double CRASH_SOUND_VOLUME = 5;
